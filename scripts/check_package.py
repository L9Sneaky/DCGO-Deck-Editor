...
def check_html_build(root: Path) -> list[str]:
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        for needle in ["DCGO Deck Browser", "CheckDeck", "app-version-label", "v1.1.5", "deck-test-react-root", "open-collection", "collection-main", "collection-import-list", "collection-edit-enabled"]:
